...
const ReleaseInfo = (props) => {
  ...
  let collection = props.collection.filter(collectionAlbum => parseInt(collectionAlbum.album.release.d_release_id) === parseInt(props.release.id))
  let wantlist = props.wantlist.filter(wantlistAlbum => parseInt(wantlistAlbum.album.release.d_release_id) === parseInt(props.release.id))
